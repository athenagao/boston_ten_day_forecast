...
def train_and_forecast(years_of_history: int):
    ...
    return data, forecast_df, mae_df
...
years = st.slider("Years of history", 2, 10, YEARS_OF_HISTORY, 1)

if st.button("Run forecast"):
    with st.spinner("Fetching data + training model..."):
        data, forecast_df, mae_df = train_and_forecast(years)
